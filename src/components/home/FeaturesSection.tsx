  ...
  return (
    <section className="relative overflow-hidden bg-white px-4 py-24 sm:px-6 lg:px-8 dark:bg-gray-950">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10" aria-hidden="true">
        <div className="absolute left-1/2 top-0 h-px w-1/2 bg-gradient-to-r from-transparent via-indigo-200 to-transparent dark:via-indigo-800" />
      </div>
      ...
      >
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-gray-500 sm:text-lg dark:text-gray-400">
            Powerful tools designed to transform the way you capture, organize,
            and enhance your ideas with artificial intelligence.
          </p>
        </div>
          ...
          {features.map((feature) => {
            ...
            return (
              <motion.div
                ...
                className="group relative cursor-pointer rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-gray-200 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900 dark:hover:border-gray-700 dark:hover:shadow-indigo-900/20"
              >
                {/* Icon */}
                <div
                  className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg transition-transform duration-300 group-hover:scale-110 ${feature.bgColor}`}
                >
                ...
                {/* Hover accent line */}
                <div className="absolute bottom-0 left-6 right-6 h-0.5 scale-x-0 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 transition-transform duration-300 group-hover:scale-x-100" />
              </motion.div>
            );
          })}
        </motion.div>
